...
![image](https://github.com/user-attachments/assets/1ce9d2c0-11d5-408c-a5e2-c1f991733604)

## PROBLEM STATEMENT
The bandit slippery walk problem is a reinforcement learning problem in which an agent must learn to navigate a 7-state environment in order to reach a goal state. The environment is slippery, so the agent has a chance of moving in the opposite direction of the action it takes.

## POLICY EVALUATION FUNCTION
![image](https://github.com/user-attachments/assets/c5ffe6b2-fc68-4e08-926c-ef7b89f981fe)

## Program:
```
Developed by:Revathi.D REG NO:212221240045
...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/4a0ca172-e67f-439c-8bee-b8cdee64747c)
